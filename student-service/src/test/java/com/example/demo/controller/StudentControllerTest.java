...
class StudentControllerTest {
    ...
    @Test
    void edadPromedio() throws Exception {
        when(studentService.edadPromedio()).thenReturn(30);
    ...
    @Test
    void mayorEdad() throws Exception {
        when(studentService.mayorEdad()).thenReturn(44);
    ...
    @Test
    void menorEdad() throws Exception {
        when(studentService.menorEdad()).thenReturn(14);
    ...
    @Test
    void mayoresDeEdad() throws Exception {
        List<Student> studentList = new ArrayList<>();
        studentList.add(new Student(1L, "Gullo", "Laura", LocalDate.of(1986,11,12)));
        studentList.add(new Student(2L, "Seri", "Martin", LocalDate.of(1982,04,12)));
        when(studentService.mayoresDeEdad()).thenReturn(studentList);
    ...
    @Test
    void menoresDeEdad() throws Exception {
        List<Student> studentList = new ArrayList<>();
        ...
        when(studentService.menoresDeEdad()).thenReturn(studentList);
    ...
    @Test
    void edadPromedioMayores() throws Exception {
        when(studentService.edadPromedioMayores()).thenReturn(34);
    ...
    @Test
    void edadPromedioMenores() throws Exception {
        when(studentService.edadPromedioMenores()).thenReturn(14);
