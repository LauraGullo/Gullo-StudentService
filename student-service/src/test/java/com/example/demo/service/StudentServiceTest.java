...
class StudentServiceTest {
    ...
    void edadPromedio() {
        ...
        studentList.add(new Student(2L,"Seri","Martin", LocalDate.of(1980,12,12)));
        when(studentRepository.findAll()).thenReturn(studentList);
        assertEquals(38, studentService.edadPromedio());
    }
    ...
    void mayorEdad() {
        ...
        studentList.add(new Student(2L,"Seri","Martin", LocalDate.of(1980,12,12)));
        when(studentRepository.findAll()).thenReturn(studentList);
        assertEquals(41, studentService.mayorEdad());
    }
    ...
    void menorEdad() {
        ...
        studentList.add(new Student(2L,"Seri","Martin", LocalDate.of(1980,12,12)));
        when(studentRepository.findAll()).thenReturn(studentList);
        assertEquals(36, studentService.menorEdad());
    }
    ...
    void mayoresDeEdad() {
        ...
        when(studentRepository.findAll()).thenReturn(studentList);
        assertFalse(studentService.mayoresDeEdad().isEmpty());
    }
    ...
    void menoresDeEdad() {
        ...
        studentList.add(new Student(4L,"Perez","Juan", LocalDate.of(2013,06,12)));
        when(studentRepository.findAll()).thenReturn(studentList);
        assertFalse(studentService.menoresDeEdad().isEmpty());
    }

    @Test
    void edadPromedioMayores() {
        List<Student> studentList = new ArrayList<>();
        studentList.add(new Student(1L,"Gullo","Maria", LocalDate.of(1986,01,01)));
        studentList.add(new Student(2L,"Seri","Martin", LocalDate.of(1980,12,12)));
        studentList.add(new Student(3L,"Lopez","Laura", LocalDate.of(2019,04,06)));
        studentList.add(new Student(4L,"Perez","Juan", LocalDate.of(2013,06,12)));
        when(studentRepository.findAll()).thenReturn(studentList);
        assertEquals(38, studentService.edadPromedioMayores());
    }

    @Test
    void edadPromedioMenores() {
        List<Student> studentList = new ArrayList<>();
        studentList.add(new Student(1L,"Gullo","Maria", LocalDate.of(1986,01,01)));
        studentList.add(new Student(2L,"Seri","Martin", LocalDate.of(1980,12,12)));
        studentList.add(new Student(3L,"Lopez","Laura", LocalDate.of(2019,04,06)));
        studentList.add(new Student(4L,"Perez","Juan", LocalDate.of(2013,06,12)));
        when(studentRepository.findAll()).thenReturn(studentList);
        assertEquals(6, studentService.edadPromedioMenores());
    }
